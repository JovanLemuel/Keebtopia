            ...
            <div class="flex">
                ...
                <div class="relative w-full md:hidden">
                    <input type="search " id="search-dropdown"
                        class="block p-2.5 w-full md:w-96 z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500"
